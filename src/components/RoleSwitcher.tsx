            ...
            <div style={{ flex: 1, minWidth: 0, textAlign: "left" }}>
              ...
              <div style={{
                ...
                <span style={{ color: badge.text, display: "flex", alignItems: "center" }}>
                  {React.cloneElement(ROLE_ICONS[currentUser.role] as React.ReactElement<{ style?: React.CSSProperties }>, { style: { width: "9px", height: "9px" } })}
                </span>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
                        <div style={{
                          ...
                          <span style={{ color: userBadge.text, display: "flex", alignItems: "center" }}>
                            {React.cloneElement(ROLE_ICONS[user.role] as React.ReactElement<{ style?: React.CSSProperties }>, { style: { width: "9px", height: "9px" } })}
                          </span>
